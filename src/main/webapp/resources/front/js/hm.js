(function () {
    var h = {}, mt = {}, c = {
        id: "ae485a95564f5efba533a36a1e39f8a9",
        dm: ["shengyuan.cn"],
    ...
    (function () {
        ...
        var d = mt.url, e = mt.Y, f = mt.O, k = mt.lang, m = mt.cookie, n = mt.i, p = mt.localStorage, g = mt.sessionStorage, b = h.C, w = h.F;
        a.prototype = {
            J: function (b, a) {
                b = "." + b.replace(/:\d+/, "");
                a = "." + a.replace(/:\d+/, "");
            ...
            Ga: function () {
                ...
                var a = document.location.hash.substring(1), e = RegExp(c.id), f = -1 < document.referrer.indexOf(b.ba), g = d.f(a, "jn"), k = /^heatlink$|^select$/.test(g);
