...
<div class="in-top">
    <div class="in-top-wrap">
        <div class="in-top-t">
            <div class="logo"><!--2016动画开始--><div class="logif"></div><!--2016动画结束--><a href="/"><img src="../images/logo.jpg" /></a></div>
            <div class="rsea">
                <div class="seach">
                    <div class="keyword search_result_pop"></div>
                    <form action="/product/search.jhtml" id="submitForm" name="submitForm" method="get">
                ...
                <div class="cart"><i id="cartCount"></i><a href="/cart/list.jhtml" >我的购物车</a></div>
            </div>
        </div>
        ...
        <div class="in-top-b">
            ...
            <div class="top-menu">
                <ul>
                    ...
                    <li>
                        <a href="mrcx.html" target="_blank">
                            每日尝鲜
                        </a>
                    </li>
                    <li>
