...
CREATE TABLE TB_USER(
 ...
 PRIMARY KEY(U_ID),
 KEY IDX_USER_U_NAME (U_NAME),
 KEY IDX_USER_U_STATE (U_STATE)
...
CREATE TABLE TB_ADMIN(
 ...
 PRIMARY KEY (AD_ID),
 KEY IDX_ADMIN_AD_NAME (AD_NAME),
 KEY IDX_ADMIN_AD_STATE (AD_STATE)
...
CREATE TABLE TB_ORDER_DETAIL (
  ...
  KEY IDX_ORDER_DETAIL_PRO_ID (P_ID),
...
CREATE TABLE TB_PRO_TYPE(
  P_TYPE_ID BIGINT UNSIGNED AUTO_INCREMENT COMMENT'商品类型ID',
  ...
  KEY IDX_PRO_TYPE_NAME (P_TYPE_NAME),
  KEY IDX_PRO_TYPE_P_ID (P_TYPE_P_ID),
...
CREATE TABLE TB_CAR (
  ...
  UPDATE_DATE DATETIME DEFAULT NOW() COMMENT '修改时间',
  PRIMARY KEY (CAR_ID),
  KEY IDX_CAR_U_ID (U_ID),
  KEY IDX_CAR_P_ID (P_ID),
